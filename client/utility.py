...
def save(location_id, server_name, meteo_data_dict, save=True):
  return _save_v15(location_id, server_name, meteo_data_dict, save)

#
# Save data to CSV file and REST API server
#
# TODO: move to kind of an "abstract class"
def _save_v15(location_id, server_name, meteo_data_dict, save=True):
  ...
  last_rain_event_timestamp=meteo_data_dict.get("last_rain_event_timestamp")
  ...
  file_name=f"data/weather_{location_id}_{server_name}_v15.txt"
  try:
